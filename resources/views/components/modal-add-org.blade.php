    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 relative">
        ...
        <form method="POST" action="{{ route('orgs.store') }}" enctype="multipart/form-data">
            ...
            <div class="relative w-full rounded-t-2xl overflow-visible">
                <!-- cover photo banner -->
                <label class="block w-full h-36 bg-gray-100 rounded-t-2xl cursor-pointer overflow-hidden relative group border-b-2 border-upv-green">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center gap-3 pointer-events-none">
                        <span class="w-9 h-9 rounded-full bg-black/50 flex items-center justify-center">
                            <svg class="w-5 h-5" fill="none" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                                <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/>
                                <circle cx="12" cy="13" r="4"/>
                            </svg>
                        </span>
                        <!-- tooltip -->
                        <span class="absolute bottom-3 left-1/2 -translate-x-1/2 bg-gray-900/80 text-white text-xs rounded-lg px-3 py-1.5 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                ...
                <div class="absolute -bottom-10 left-6 group">
                    <label class="block w-20 h-20 rounded-full border-2 border-upv-green bg-gray-200 cursor-pointer overflow-hidden relative">
                        <img id="profilePreview" alt="" class="w-full h-full object-cover hidden">
                        <div class="absolute inset-0 flex items-center justify-center bg-black/30 rounded-full pointer-events-none">
                            <svg class="w-5 h-5" fill="none" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                                <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/>
                                <circle cx="12" cy="13" r="4"/>
                            </svg>
                    ...
                    <span class="absolute -bottom-8 left-1/2 -translate-x-1/2 bg-gray-900/80 text-white text-xs rounded-lg px-3 py-1.5 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col flex-1">
                            ...
                            <textarea
                                ...
                                rows="5"
                                class="w-full h-full border-2 border-upv-green rounded-xl px-4 py-2.5 text-sm text-gray-700 placeholder-gray-400 outline-none resize-none font-body"
                            ></textarea>
                        </div>
